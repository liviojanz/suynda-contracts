 ...
 */
import type { CapabilityAvailability, EntitlementStatus, LauncherAction, ModuleKey, ModuleKind, ModuleLevel, TokenInitiator } from "./enums.js";
import type { IsoDateTime } from "./deposito.js";
/** GET. JWKS de los tokens de PERSONA. `foundation/src/http/routes/jwks.ts:14`. */
export declare const FOUNDATION_JWKS_USERS_PATH: "/.well-known/jwks-users.json";
/** GET. JWKS de los tokens de SERVICIO. `jwks.ts:19`. */
export declare const FOUNDATION_JWKS_SERVICES_PATH: "/.well-known/jwks-services.json";
/**
 ...
 */
export declare const FOUNDATION_ENTITLEMENTS_CHECK_PATH: "/v1/entitlements/check";
/** El único query param de `/v1/entitlements/check`. `entitlements.ts:105`. */
export declare const FOUNDATION_ENTITLEMENTS_CHECK_MODULE_QUERY: "module";
/**
 ...
 */
export declare const FOUNDATION_SHELL_PATH: "/v1/shell";
/**
 ...
 */
export declare const PLATFORM_JWT_ALG: "Ed25519";
/**
